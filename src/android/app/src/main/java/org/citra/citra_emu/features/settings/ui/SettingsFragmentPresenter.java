...
public final class SettingsFragmentPresenter {
    ...
    private void addVRSettings(ArrayList<SettingsItem> sl) {
        ...
        sl.add(new SingleChoiceSetting(SettingsFile.KEY_VR_CPU_LEVEL, Settings.SECTION_VR, R.string.vr_cpu_level, R.string.vr_cpu_level_decription, R.array.vrCpuLevelNames, R.array.vrCpuLevelValues, 4, vrCpuLevel));
